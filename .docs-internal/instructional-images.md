...
- Använd GIF ifrån vad-ar-foto3d.md
...
- Typ: Skärminspelning (GIF)  
  ...
  - Visa en enkel webbsida med text och en blå klickbar länk, t.ex. "See the product in 3D" (understruken, blå standardlänkstil).  
...
- Typ: Skärminspelning (GIF)  
  ...
  - Visa en webbsida med en knapp, t.ex. "[Visa i 3D]" eller "Se modellen i 3D" (gärna med kontrastfärg och rundade hörn).  
...
- Typ: Skärminspelning (GIF)  
  ...
  - Visa en webbsida med en iframe som är tydligt stylad: t.ex. rundade hörn, skugga, responsiv ram, rubrik ovanför: “Utforska i 3D”.  
...
- Hur används det:  
  Typ: Bild  
  Syfte: Visa en digital mockup av en fysisk produkt med en tryckt QR-kod som leder till en FOTO-3D-modell.
  ...
  Fokus:  
  Tydligt visa hur en fysisk produkt kan kopplas till en 3D-modell via QR.
